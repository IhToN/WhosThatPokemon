...
;(function (k, C) {
  function M(b, a) {
    ...
    var f = k(e.node), w = e.select("g.lievo-main"), g = e.g().addClass("lievo-setrotation");
    e.prepend(g);
    ...
    f =
      w.rect(-19, -19, 4, 4).addClass("lievo-checkshift lievo-donotdraw lievo-nohoverstroke lievo-nohovercolor").attr({
        fill: "none",
        stroke: "#ffffff",
        "stroke-width": 2,
        "stroke-linecap": "butt",
    ...
    "round" === a.strokeStyle ? q.forEach(function (a) {
    ...
    }) : "square" === a.strokeStyle && q.forEach(function (a) {
    ...
    var r, N = function () {
      ...
      "original" !== a.strokeWidth ? (q.forEach(function (b) {
        ...
        if ("none" !==
          ...
          var c = b.data("initStrokeWidth").replace(/[0-9.]/g, ""),
            d = b.data("initStrokeWidth").replace(/[^0-9.]/g, "") / 2, d = 1 / a.scaleStrokeFactor * d;
          b.node.setAttribute("stroke-width", d + c);
          b.data("curStrokeWidth", d + c)
        }
      }), r = 1 / a.scaleStrokeFactor / 2) : (q.forEach(function (a) {
        "none" !== a.attr("stroke") && a.data("curStrokeWidth", a.data("initStrokeWidth"))
      }), r = e.select(".lievo-checkshift").attr("stroke-width").replace(/[^0-9.]/g, "") / 2);
      (0 === a.strokeWidthFactorOnHover || a.strokeWidthFactorOnHover) && q.forEach(function (b) {
        if ("none" !==
          ...
          if (c) {
            var d = ("" + c).replace(/[0-9.]/g, ""), c = +("" + c.replace(/[^0-9.]/g, "")) * a.strokeWidthFactorOnHover;
    ...
    q.forEach(function (b) {
      ...
      if (m) {
        if ("none" === c) b.data("actionFill", "none"); else if (c.toLowerCase().match(/url\(/)) b.data("actionFill", c); else {
          if ("lighter" === m) var d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction : G(c, -a.saturation, a.brightness); else if ("darker" === m) d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction : G(c, a.saturation, -a.brightness); else if ("hue" === m.replace(/[^hue]/g, "")) d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction :
            O(c, m.replace(/[^0-9.]/g, "") ? m.replace(/[^0-9.]/g, "") : 0); else if ("custom" === m) switch (a.style) {
            case "solid":
    ...
    a.rotate && (h.set(e.select("g.lievo-setrotation").node, {
      rotation: a.rotate,
      svgOrigin: c
    ...
    if (a.animated) {
      var d = e.selectAll("circle, ellipse, g, image, line, path, polygon, polyline, rect, text, use"), B = new y;
        ...
        d.forEach(function (b) {
          if ("end" !== a.morphState) {
            if (!b.hasClass("lievo-nohovercolor") && "g" !== b.type.toLowerCase()) {
              var c =
                b.data("actionStroke"), d = b.data("actionFill");
          ...
          } else b.hasClass("lievo-nohovercolor") || "g" === b.type.toLowerCase() || (c = b.data("actionStroke"), d = b.data("actionFill"), c && "none" !== c && h.set(b.node, {stroke: c}), d && "none" !== d && !d.match(/url\(/) && h.set(b.node, {fill: d}), c = b.data("curStroke"), d = b.data("curFill"), c && "none" !== c && (c = h.to(b.node, a.use_duration,
            {stroke: c}), z.add(c, 0)), d && "none" !== d && !d.match(/url\(/) && (b = h.to(b.node, a.use_duration, {fill: d}), z.add(b, 0)))
        })
      }
      d.forEach(function (a) {
        if (a.attr("data-animdata")) {
          var b = JSON.parse(a.attr("data-animdata").replace(/\'/g, '"')), c = new y;
          b.steps.forEach(function (b, d) {
            ...
            b.vars.path && (b.vars.morphSVG =
              b.vars.path);
            if (b.vars.bezier && b.vars.bezier.values && "string" === typeof b.vars.bezier.values) for (g = n.path.toCubic(b.vars.bezier.values).toString(), g = g.replace(/[M|m]/g, "").replace(/[C|c]/g, ","), g = g.split(","), b.vars.bezier.values = [], d = 0; d < g.length; d += 2) {
              var e = {};
              e.x = g[d];
              e.y = g[d + 1];
            ...
            K || L ? b.vars.drawSVG ? "0%" === b.vars.drawSVG || 0 === b.vars.drawSVG ? (g = h.to(a.node, +b.duration, b.vars), g.eventCallback("onStart", function () {
              "square" === a.data("initStrokeLinecap").toLowerCase() && h.set(a.node,
                {attr: {"stroke-linecap": "round"}});
              "miter" === a.data("initStrokeLinejoin").toLowerCase() && h.set(a.node, {attr: {"stroke-linejoin": "round"}})
            })) : "100%" === b.vars.drawSVG ? (g = h.to(a.node, +b.duration, b.vars), g.eventCallback("onComplete", function () {
              "square" === a.data("initStrokeLinecap").toLowerCase() && h.set(a.node, {attr: {"stroke-linecap": "square"}});
              "miter" === a.data("initStrokeLinejoin").toLowerCase() && h.set(a.node, {attr: {"stroke-linejoin": "miter"}})
            })) : g = h.to(a.node, +b.duration, b.vars) : g = h.to(a.node, +b.duration,
    ...
    } else q = e.selectAll("circle, ellipse, g, image, line, path, polygon, polyline, rect, text, use"), q.forEach(function (a) {
      a.node.removeAttribute("data-animdata")
    });
    b.data("drawTL", t);
    b.data("mainTL", p);
    ...
    if (a.animated) if (!a.morph) if ("click" === a.eventType) a.event_elem.on("click.LiviconEvo", function () {
      ...
      if ("hover" === a.eventType) if (d =
          ...
          p.isActive() && (a.ending = !0, p.tweenTo(p.duration(), {
            onComplete: function () {
              p.pause().totalProgress(0);
              -1 === a.use_repeat && "function" == typeof a.afterAnim && a.afterAnim();
              a.ending = !1
            }
          }))
        }, -1 === a.use_repeat) a.event_elem.on("mouseenter.LiviconEvo", d).on("mouseleave.LiviconEvo", l); else a.event_elem.on("mouseenter.LiviconEvo", function () {
        a.drawn && b.playLiviconEvo()
      })
    } else if (a.morph) if ("click" === a.eventType) a.event_elem.on("click.LiviconEvo", function () {
      a.drawn &&
      b.playLiviconEvo()
    }); else "hover" === a.eventType && (l = function () {
      a.drawn && p.reverse()
    }, a.event_elem.on("mouseenter.LiviconEvo", function () {
      a.drawn && b.playLiviconEvo()
    ...
    if (d = b.find("svg")[0].getScreenCTM()) l =
      -d.e % 1, f = -d.f % 1, 0 == l ? l = 0 : -.5 >= l && (l += 1), 0 == f ? f = 0 : -.5 >= f && (f += 1), b.find("svg").css({
      left: l + "px",
      top: f + "px"
    }), a.tryToSharpen && (l = e.select(".lievo-checkshift"), f = e.select(".lievo-morphpattern"), w = n.matrix(), l && (l = l.getBBox(), 0 !== (l.x + r) * d.a % 1 && (h.set(e.select("g.lievo-setsharp").node, {
      x: "+=" + ((l.x - r) * d.a % 1 / d.a || 0),
      svgOrigin: c
    }), w.e = (l.x - r) * d.a % 1 / d.a || 0), 0 !== (l.y + r) * d.d % 1 && (h.set(e.select("g.lievo-setsharp").node, {
      y: "+=" + ((l.y - r) * d.d % 1 / d.d || 0),
      svgOrigin: c
    }), w.f = (l.y - r) * d.d % 1 / d.d || 0), f && f.attr("patternTransform",
      w.toString())));
  ...
  function O(b, a) {
    var e = n.color(b), e = n.rgb2hsb(e.r, e.g, e.b);
    a = Math.abs(a) / 360 % 1;
    e.h = (e.h + a) % 1;
    return n.hsb(e.h, e.s, e.b)
  }

  var v = !1, h = window.TweenMax, y = window.TimelineMax, P = window.Power0, n = window.Snap, Q = window.verge;
  ...
  var K = "ActiveXObject" in window ? !0 : !1, L = navigator.userAgent.match(/Edge\/\d+/) ? !0 : !1;
  k.fn.extend({
    addLiviconEvo: function (b, a) {
      if (2 > arguments.length) var e = b === Object(b) ? b : {}; else b === Object(b) ? e = b : (e = {}, e[b] = a);
      return this.each(function () {
        var a = k(this), b = a.data("options"), w = a.data("saved_options"), g = {};
        ...
        if (g.name) {
          ...
          k.ajax({
            url: g.pathToFolder + g.name, type: "GET", dataType: "text", global: !0, success: function (b) {
    ...
    updateLiviconEvo: function (b, a) {
      if (2 > arguments.length) var e = b === Object(b) ? b : {}; else b === Object(b) ? e = b : (e = {}, e[b] = a);
      return this.each(function () {
        var a = k(this), b = a.data("saved_options");
        if (b) {
      ...
      return this.each(function () {
        var a = k(this), b = a.data(), c = b.saved_options;
        if (c) {
          var d = b.drawTL, b = b.mainTL, l = a.find("circle, ellipse, line, path, polygon, polyline, rect");
      ...
      if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.force = b; else 2 === arguments.length ? b === Object(b) ?
        (c = b, c.force = a) : (c = {}, c[b] = a, c.force || (c.force = !1)) : (c = {}, c[b] = a, c.force = e);
      for (var f in c) c.hasOwnProperty(f) && (c[f] = u(c[f]), c[f] = A(c[f]));
      return this.each(function () {
        var a = k(this), b = a.data(), d = b.saved_options;
        if (d) {
          var e = b.drawTL, f = b.mainTL, b = 0 === c.drawDelay || c.drawDelay ? c.drawDelay : d.drawDelay,
            r = 0 === c.drawTime || c.drawTime ? c.drawTime : d.drawTime,
            u = 0 === c.drawStagger || c.drawStagger ? c.drawStagger : d.drawStagger,
            m = c.drawStartPoint ? c.drawStartPoint : d.drawStartPoint, t = c.drawColor ? c.drawColor : d.drawColor,
            p = 0 === c.drawColorTime || c.drawColorTime ? c.drawColorTime : d.drawColorTime,
            B = c.drawEase ? c.drawEase : d.drawEase, z = c.beforeDraw ? c.beforeDraw : d.beforeDraw,
            x = c.afterDraw ? c.afterDraw : d.afterDraw, E = c.duringDraw ? c.duringDraw : d.duringDraw,
          ...
          if (!e.isActive() && !f.isActive() && !d.drawn) {
            ...
            var f = function () {
              ...
              "same" !== t ? (h.set(this.target, {
                strokeOpacity: 1,
                stroke: t
              }), "none" === a.data("curStroke") && a.attr({"stroke-width": 1 / d.scaleStrokeFactor})) : (h.set(this.target, {strokeOpacity: 1}), "none" === a.data("curStroke") && a.attr({
                "stroke-width": 1 /
            ...
            switch (m) {
              case "middle":
                ...
                break;
              case "end":
                e.staggerFromTo(v, r, {drawSVG: "100% 100%"}, {
                  drawSVG: "0% 100%",
                  ease: B,
                  onStart: f,
                  onComplete: D
                ...
                break;
              default:
                e.staggerFromTo(v, r, {drawSVG: "0% 0%"}, {
                  drawSVG: "0% 100%",
                  ease: B,
                  onStart: f,
                  onComplete: D
      ...
      return this.each(function () {
        var a = k(this), b = a.data(), d = b.saved_options;
        if (d) {
          var e = b.drawTL, f = b.mainTL, b = 0 === c.eraseDelay || c.eraseDelay ? c.eraseDelay : d.eraseDelay,
            r = 0 === c.eraseTime || c.eraseTime ? c.eraseTime : d.eraseTime,
            u = c.eraseStartPoint ? c.eraseStartPoint : d.eraseStartPoint, m = c.eraseEase ? c.eraseEase : d.eraseEase,
            t = c.beforeErase ? c.beforeErase : d.beforeErase, p = c.afterErase ? c.afterErase : d.afterErase,
            v = c.duringErase ? c.duringErase :
              d.duringErase, z = "undefined" != typeof c.eraseReversed ? c.eraseReversed : d.eraseReversed,
          ...
          if (!e.isActive() && !f.isActive() && d.drawn) {
            ...
            var f = function () {
              "none" === n(this.target).data("curStroke") && n(this.target).attr({
                "stroke-width": 1 / d.scaleStrokeFactor,
                stroke: n(this.target).data("curFill")
              });
              h.to(this.target, r, {fillOpacity: 0})
            }, z = function () {
              h.set(this.target, {strokeOpacity: 0, fillOpacity: 0});
              "none" === n(this.target).data("curStroke") && h.set(this.target, {"stroke-width": 0, stroke: "none"})
            }, y = function () {
              d.drawn = !1
            };
            e.clear();
            ...
            switch (u) {
              case "middle":
                e.staggerFromTo(x, r, {drawSVG: "0% 100%"}, {
                  drawSVG: "50% 50%",
                  ease: m,
                  onStart: f,
                  onComplete: z
      ...
      if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.force = b; else 2 === arguments.length ? b === Object(b) ? (c = b, c.force = a) : (c = {}, c[b] = a, c.force || (c.force = !1)) : (c = {}, c[b] = a, c.force = e);
      for (var f in c) c.hasOwnProperty(f) && (c[f] = u(c[f]), c[f] = A(c[f]));
      return this.each(function () {
        var a = k(this), b = a.data(), d = b.saved_options;
        if (d) {
          var a = b.drawTL, b = b.mainTL, e = 0 === c.duration || c.duration ? c.duration : d.duration,
            f = 0 === c.delay || c.delay ? c.delay : d.delay, h = 0 === c.repeat || c.repeat ? c.repeat : d.repeat,
            n = 0 === c.repeatDelay || c.repeatDelay ? c.repeatDelay : d.repeatDelay,
            m = c.beforeAnim ? c.beforeAnim : d.beforeAnim, t = c.afterAnim ? c.afterAnim : d.afterAnim,
            p = c.duringAnim ? c.duringAnim : d.duringAnim;
          d.animated && (A(c.force) && (a.pause().totalProgress(1), b.pause().totalProgress(0), d.drawn = !0), "default" === e && (e = d.def_duration), b.getChildren(!1, !1, !0).forEach(function (a) {
            a.duration(e)
          }),
          0 >= f && (f = .001), b.delay(f), "default" === h ? h = d.def_repeat : "loop" === h && (h = -1), "default" === n && (n = d.def_repeatDelay), 0 >= n && (n = .001), d.morph ? (b.repeat(0).repeatDelay(0), "function" == typeof m && b.eventCallback("onStart", m), "function" == typeof p && b.eventCallback("onUpdate", p), b.eventCallback("onComplete", function () {
      ...
      return this.each(function () {
        var b =
          k(this), a = b.data(), e = a.saved_options;
      ...
      if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.total = b; else 2 === arguments.length ? b === Object(b) ? (c = b, c.total = a) :
        (c = {}, c[b] = a, c.total || (c.total = !1)) : (c = {}, c[b] = a, c.total = e);
      return this.each(function () {
        var a = k(this), b = a.data("saved_options");
        if (b) {
          var e = c.beforeRemove ? c.beforeRemove : b.beforeRemove, d = c.afterRemove ? c.afterRemove : b.afterRemove;
          b.event_elem && b.event_elem.off(".LiviconEvo");
          b.event_elem = C;
          "function" == typeof e && e();
      ...
      if (1 <= arguments.length) return this.each(function () {
        var a = k(this).data("saved_options"), e = k(this).data("mainTL");
